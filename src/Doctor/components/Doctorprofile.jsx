...
const Doctorprofile = () => {
  ...
  console.log(docProfile, "i got docProfileeee");

  useEffect(() => {
    const docToken = localStorage.getItem("doctorToken");
    instance
      .get("/doctors/fetchdoctorprofile", {
        headers: {
    ...
    <>
      <div className="flex items-start justify-items-start">
        <div className="grid grid-rows-2">
          ...
          <div className=" bg-blue-100 border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700 mt-5 h-64">
            <div className="px-5 ">
